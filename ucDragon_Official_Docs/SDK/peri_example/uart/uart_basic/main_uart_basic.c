...
{
	Board_LED_Set(LED0, false);
	Board_LED_Set(LED1, false);
	Board_LED_Set(LED2, false);
	Board_LED_Set(LED3, false);
	Board_LED_Set(LED4, false);
	Board_LED_Set(LED5, false);
	Board_LED_Set(LED6, false);
	Board_LED_Set(LED7, false);
}
...
int main(void)
{
	...
	Board_LED_Set(LED4, true);
	Board_LED_Set(LED5, true);
	Board_LED_Set(LED6, true);
	Board_LED_Set(LED7, true);
	/* Loop forever */
	while (1) {
		__WFI();
